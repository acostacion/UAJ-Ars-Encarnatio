...
public class UIInteractionEvent : TrackerEvent {
    ...
    public UIInteractionEvent(int eventId, DateTime timestamp, int playerId, int sessionId, InteractionTarget target, Vector2 clickPosition) : base("ui_interaction", "UI", eventId, timestamp, playerId, sessionId) { 
