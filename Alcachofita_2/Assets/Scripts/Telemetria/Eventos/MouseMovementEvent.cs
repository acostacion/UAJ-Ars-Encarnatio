...
public class MouseMovementEvent : TrackerEvent {
    ...
    public MouseMovementEvent(int eventId, DateTime timestamp, long sessionId, float mouse_pos_x, float mouse_pos_y) : base("mouse_movement", "Gameplay", eventId, timestamp, sessionId) {
