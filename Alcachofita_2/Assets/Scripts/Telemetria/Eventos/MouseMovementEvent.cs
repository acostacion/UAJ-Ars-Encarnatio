...
public class MouseMovementEvent : TrackerEvent {
    ...
    public MouseMovementEvent(int eventId, int timestamp, int playerId, int sessionId, Vector2 mousepos) : base("mouse_movement", "Gameplay", eventId, timestamp, playerId, sessionId) {
